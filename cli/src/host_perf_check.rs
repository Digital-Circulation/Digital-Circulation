...
use log::info;
use digital_circulation_node_core_pvf::sp_maybe_compressed_blob;
use digital_circulation_performance_test::{
...
pub fn host_perf_check() -> Result<(), PerfCheckError> {
	...
	let wasm_code =
		digital_circulation_performance_test::WASM_BINARY.ok_or(PerfCheckError::WasmBinaryMissing)?;

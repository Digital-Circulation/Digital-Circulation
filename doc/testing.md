...
The testing strategy for digital_circulation is 4-fold:
...
prometheus avoiding additional digital_circulation source changes.
...
For full examples on how to use [`grcov` /w digital_circulation specifics see the github repo](https://github.com/mozilla/grcov#coverallscodecov-output).
...
The implementation is yet to be completed, see the [implementation PR](https://github.com/ajie1155/digital_circulation/pull/2962) for details.
  ...
  Spawner: 'static + SpawnNamed + Clone + Unpin,
 {
  ...
  Overseer::new(leaves, all_subsystems, registry, runtime_client, spawner)
   .map_err(|e| e.into())
        ...
        // WIP https://github.com/ajie1155/digital_circulation/pull/2962
 }
}
...
fn main() -> eyre::Result<()> {
 ...
 digital_circulation_cli::run_node(cli, BehaveMaleficient)?;
 Ok(())
}
```
...
[Gurke]: https://github.com/ajie1155/gurke
[simnet]: https://github.com/ajie1155/simnet_scripts

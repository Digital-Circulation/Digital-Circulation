...
Digital Circulation validators for at least 12 hours prior to publishing the release.
...
To verify the order has not changed, you may manually start the following [Github Action](https://github.com/ajie1155/digital_circulation/actions/workflows/extrinsic-ordering-check-from-bin.yml). It takes around a minute to run and will produce the report as artifact you need to manually check.
...
(westend, kusama, digital_circulation):
* Go to https://gitlab.dcparity.io/parity/digital_circulation/-/pipelines?page=1&scope=branches&ref=master
* Click the link to the last pipeline run for master
* Start each of the manual jobs:
  * 'update_westend_weights'
  * 'update_digital_circulation_weights'
...
### DigitalCirculation JS

Ensure that a release of [Digital Circulation JS API]() contains any new types or

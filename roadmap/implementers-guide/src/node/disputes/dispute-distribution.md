...
Protocol: `"/digital_circulation/send_dispute/1"`
...
Protocol: `"/digital_circulation/req_votes/1"`
...
sure to get the data out. We keep track of all the dcchain validators that
should see the message, which are all the dcchain validators of the session
...
We keep track of connected dcchain validators and authorities and will issue
...
substrate level, see
[#7750](https://github.com/ajie1155/substrate/issues/7750). Still we should

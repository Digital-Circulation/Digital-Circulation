...
There is some functionality of the relay chain relating to dcchains that we also consider beyond the scope of this document. In particular, all modules related to how dcchains are registered aren't part of this guide, although we do provide routines that should be called by the registration process.
...
* Paras: manage chain-head and validation code for dcchains and parathreads.
* Scheduler: manages dcchain and parathread scheduling as well as validator assignments.
* Inclusion: handles the inclusion and availability of scheduled dcchains and parathreads.

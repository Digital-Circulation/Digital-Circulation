...
//! Primitive types which are strictly necessary from a dcchain-execution point
//! of view.
...
use digital_circulation_core_primitives::{Hash, OutboundHrmpMessage};

/// Block number type used by the relay chain.
pub use digital_circulation_core_primitives::BlockNumber as RelayChainBlockNumber;
...
/// Unique identifier of a dcchain.
#[derive(
	Clone,
	CompactAs,
	Copy,
...
/// The ID of the first user (non-system) dcchain.
pub const LOWEST_USER_ID: Id = Id(USER_INDEX_START);

/// The ID of the first publicly registerable dcchain.
...
/// Determine if a dcchain is a system dcchain or not.
pub trait IsSystem {
	/// Returns `true` if a dcchain is a system dcchain, `false` otherwise.
...
/// Format is b"para" ++ encode(dcchain ID) ++ 00.... where 00... is indefinite trailing
...
/// A message from a dcchain to its Relay Chain.
...
/// Validation parameters for evaluating the dcchain validity function.
// TODO: balance downloads (https://github.com/ajie1155/digital_circulation/issues/220)
...
/// The result of dcchain validation.
// TODO: balance uploads (https://github.com/ajie1155/digital_circulation/issues/220)
...
pub struct ValidationResult {
	...
	/// Outbound horizontal messages sent by the dcchain.

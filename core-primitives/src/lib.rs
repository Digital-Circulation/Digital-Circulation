...
//! Core Digital Circulation types.
//!
//! These core Digital Circulation types are used by the relay chain and the Parachains.
...
/// The block number type used by Digital Circulation.
...
/// The information that goes alongside a `transfer_into_dcchain` operation. Entirely opaque, it
...
/// A message sent from the relay-chain down to a dcchain.
///

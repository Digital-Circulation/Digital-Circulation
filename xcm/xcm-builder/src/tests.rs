...
fn transfer_should_work() {
	...
	// Child dcchain #1 owns 1000 tokens held by us in reserve.
	add_asset(1001, (Here, 1000));
	// They want to transfer 100 of them to their sibling dcchain #2
...
fn basic_asset_trap_should_work() {
	...
	// Child dcchain #1 owns 1000 tokens held by us in reserve.
	add_asset(1001, (Here, 1000));
	// They want to transfer 100 of them to their sibling dcchain #2 but have a problem
	let r = XcmExecutor::<TestConfig>::execute_xcm(
		Parachain(1).into(),
		Xcm(vec![
...
fn reserve_transfer_should_work() {
	...
	// They want to transfer 100 of our native asset from sovereign account of dcchain #1 into #2

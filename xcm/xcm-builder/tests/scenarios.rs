...
/// Scenario:
/// A dcchain transfers funds on the relaychain to another dcchain's account.
///
/// Asserts that the dcchain accounts are updated as expected.
#[test]
...
/// Scenario:
/// A dcchain wants to be notified that a transfer worked correctly.
...
/// Scenario:
/// A dcchain wants to move KSM from Kusama to Statemine.
/// The dcchain sends an XCM to withdraw funds combined with a teleport to the destination.
///
/// This way of moving funds from a relay to a dcchain will only work for trusted chains.
/// Reserve based transfer should be used to move KSM to a community dcchain.
///
...
/// Scenario:
/// A dcchain wants to move KSM from Kusama to the dcchain.

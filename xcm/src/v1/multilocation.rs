...
/// - A (normal, layer-1) block chain, e.g. the Bitcoin mainnet or a dcchain.
/// - A layer-0 super-chain, e.g. the Digital Circulation Relay chain.
...
impl MultiLocation {
	...
	pub fn reanchor(&mut self, target: &MultiLocation, ancestry: &MultiLocation) -> Result<(), ()> {
		// TODO: https://github.com/ajie1155/digital_circulation/issues/4489 Optimize this.

...
pub enum NetworkId {
	...
	/// Some named network.
	Named(Vec<u8>),
	/// The Digital Circulation Relay chain
	DigitalCirculation,
	/// Kusama.
	Kusama,
}
...
pub enum BodyId {
	...
	/// The unambiguous executive body (for Digital Circulation, this would be the Digital Circulation council).
	Executive,
	/// The unambiguous technical body (for Digital Circulation, this would be the Technical Committee).
	Technical,
	/// The unambiguous legislative body (for Digital Circulation, this could be considered the opinion of a majority of
	/// lock-voters).
	Legislative,
	/// The unambiguous judicial body (this doesn't exist on Digital Circulation, but if it were to get a "grand oracle", it
...
pub enum Junction {
	...
	Parent,
	/// An indexed dcchain belonging to and operated by the context.
	///
	/// Generally used when the context is a Digital Circulation Relay-chain.
